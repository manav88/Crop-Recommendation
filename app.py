...
app.layout = html.Div(children=[
                  html.Div(className='row',  
                           ...
                           html.Div(className='six columns div-user-controls',
                                    children = [
                                        html.P('Crop Recommendation System', style = {'font-size': '35px'}),
            
                                        html.H2(' Based on seven characteristics, this application will recommend the ideal crop for farmers to grow on their fileds.', style = {'font-size': '20px'}),
                                        html.Br(),
                                        html.Div([
                           ...
                           html.Div(className='eight columns div-for-charts bg-grey',  
                                    style={'background-image':'url("/assets/img.webp")','position':'center','height':200,'width':1300},
                                    children = [
                                    html.H2(),
                                   ]),
                                    ...
                                    html.Div([
                                        html.Div([ 
                                            html.H2('Prediction will be displayed here:', style = {"padding-top": "0px","margin-top":"30px" ,'font-size': '25px'}),
                         ...
                         html.Div([
                                        html.Div([ 
                                            html.H2('Made by MANAV ', style = {"margin-left": "auto","margin-top":"30px" ,'font-size': '25px','color':'cyan'}),
        ...
        if 'submit_button' in trigger:
            return [fig,
                    html.P([f'Recommended crop:  {pred_crop_name.capitalize()}',
                            html.Br(),
                            'Our Detection system is suggesting ', 
